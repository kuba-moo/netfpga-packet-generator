...
nf_PCI_write32($delay, $batch, RATE_LIMIT_0_TOKEN_INTERVAL_REG(), 1000);
nf_PCI_write32($delay, $batch, RATE_LIMIT_0_TOKEN_INC_REG(), 1);
...
# Expect only one packet as the delay is somwwhat extreme
