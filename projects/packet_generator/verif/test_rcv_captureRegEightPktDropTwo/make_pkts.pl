...
###############################
#
# Enable packet generator with capture and send in packet
$delay = '@22us';
...
# Enable the packet generator with packet drop and send in a packet
$delay = '@28us';
nf_PCI_write32($delay, $batch, &PKT_GEN_CTRL_ENABLE_REG(), 0x00000f0f);
...
# Enable the packet generator with packet capture and send in a packet
$delay = '@34us';
nf_PCI_write32($delay, $batch, &PKT_GEN_CTRL_ENABLE_REG(), 0x0000000f);
